...
@ManagedBean
@RequestScoped 
public class EnviadosBeans implements Serializable{
	 ...
	 * @since 1.0
	 */
	static Logger logger = Logger.getLogger(EnviadosBeans.class);
...
//    private static final String PASSWORD = "grupo32014"; // Must be valid password for smit0012
	...
	/**
	 * Metodo encargado de la obtencion de correos enviados
	 * @since 1.0
	 */   
@PostConstruct 
	public void  enviadosBeans() {
		...
		try {
			...
			correoSmall = bandejaCorreoModelMB.getCorreosEnviados();
			
			logger.debug("[RecibidosBeans] correoSmall:" + correoSmall.size());
