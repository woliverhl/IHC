...
public class PersonaDAO implements PersonaIDAO {
	 ...
	 * @return Lista de objetos personas. 
	 */
	public List<Persona> obtenerPersonasPorIdGrupo(int idgrupo) throws Exception {

		try {
			log.info("Antes de llamar createNamedQuery");
			List<PersonaEntitie> lpe = entityManager.createNamedQuery(PersonaEntitie.SQL_SELECT_ALL, PersonaEntitie.class).setParameter("idgrupo", idgrupo) .getResultList();
