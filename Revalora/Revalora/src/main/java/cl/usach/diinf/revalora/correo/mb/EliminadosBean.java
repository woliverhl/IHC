...
@ManagedBean
@RequestScoped 
public class EliminadosBean implements Serializable{
	 ...
	 * @since 1.0
	 */
	static Logger logger = Logger.getLogger(EliminadosBean.class);
...
//    private static final String PASSWORD = "grupo32014"; // Must be valid password for smit0012
	...
	/**
	 * Metodo encargado de la obtencion de correos eliminados
	 * @since 1.0
	 */   
@PostConstruct 
	public void  eliminadosBean() {
		
		logger.debug("[EliminadosBean] eliminadosBean - ");

		
		try {
			
			correoSmall = bandejaCorreoModelMB.getCorreosEliminados();
			
			logger.debug("[EliminadosBean] correoSmall:" + correoSmall.size());
